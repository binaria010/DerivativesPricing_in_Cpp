...
// define the constructor and other methods for the classes declared in payoff3.h
// in this version we include copy constructor
...
*/
std::unique_ptr<PayOff> PayOffCall::clone() const   //using smart pointers
{
...
std::unique_ptr<PayOff> PayOffPut::clone() const //using smart pointers
{
...
*/
std::unique_ptr<PayOff> PayOffDigital::clone() const   // with smart pointers
{
    return make_unique<PayOffDigital>(*this);
}
...
//copy constructor with raw pointers
/*
PayOff* PayOffDoubleDigital::clone() const{
    return new PayOffDoubleDigital(*this);
}
*/
std::unique_ptr<PayOff> PayOffDoubleDigital::clone() const   ///using smart pointers
{
